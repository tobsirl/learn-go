...
| [convert_number_to_reversed_array_of_digits](./convert_number_to_reversed_array_of_digits) | `convertnumbertoreversedarrayofdigits` | `Digitize(n int) []int`                           | Converts an integer to a slice of its digits in reverse order.                           |
| [keep_hydrated](./keep_hydrated)                                                           | `keephydrated`                         | `Liters(time float64) int`                        | Returns the number of liters (rounded down) drunk in a given time (1 liter per 2 hours). |
| [returning_strings](./returning_strings)                                                   | `returningstrings`                     | `Greet(name string) string`                       | Returns a greeting string for the given name.                                            |
| [summation](./summation)                                                                   | `summation`                            | `Summation(n int) int`                            | Returns the sum of all numbers from 1 to n.                                              |
| [you_cant_code_under_pressure](./you_cant_code_under_pressure)                             | `youcantcodeunderpressure`             | `DoubleInteger(i int) int`                        | Doubles the given integer.                                                               |
